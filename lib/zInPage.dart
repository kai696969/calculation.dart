...
class zInPage extends StatelessWidget
{
  ...
  zInPage ({required j ,required realZL ,  required imaginaryZL ,required realZo ,
              ...
              child:  Column(
                children: [
                 ...
                 FittedBox(child: rcMethod1var(variables),),
                  ...
                  FittedBox(child:Math.tex("${r' \,\beta= '}${variables.beta}${r'\; '},${r'\; '}Z${r'\, '}position = ${variables.zPosition}m " , textStyle:  TextStyle(fontSize: 25 , color: Colors.black) ,), ),
